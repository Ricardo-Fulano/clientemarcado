...
const PLANOS: Record<PlanoTipo, { desc: string; beneficios: string[]; icone: any }> = {
  free: {
    desc: 'Ideal para começar sua presença online com links básicos.',
    icone: Sparkles,
    beneficios: [
  ...
  minipage: {
    desc: 'Página profissional com links, destaques, vídeos e agenda/eventos.',
    icone: CreditCard,
    beneficios: [
      'Banner com vídeo',
  ...
  loja: {
    desc: 'Vitrine para produtos, achadinhos, músicas, cursos, divulgações e vendas.',
    icone: Store,
    beneficios: [
      'Banner com vídeo',
      'Links rápidos ilimitados',
  ...
  essencial: {
    desc: 'MiniPage completa com loja, agenda, clientes e gestão.',
    icone: CheckCircle2,
    beneficios: [
      'Banner com vídeo',
      'Links rápidos ilimitados',
  ...
  equipe: {
    desc: 'Para negócios com equipe, agenda compartilhada e controle completo.',
    icone: Crown,
    beneficios: [
      'Banner com vídeo',
      'Links rápidos ilimitados',
