                ...
                {parceiros.length === 0 ? (
                  ...
                  return (
                    <div key={p.id} className="tbl-row" style={{ gridTemplateColumns: '1fr', gap: '10px' }}>
                      ...
                      <div style={{ padding: '8px 12px', background: 'rgba(255,255,255,.04)', borderRadius: '8px', display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap', overflow: 'hidden', maxWidth: '100%' }}>  
