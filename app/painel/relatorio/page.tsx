      ...
      <div className="psb-main">
        <div className="pg"><div className="bdy">
          ...
          <div className="kpi-grid">
            {[
              {l:'Receita total',d:receitaPagamentos>0?'Pagamentos confirmados':'Agendamentos realizados',v:fBRL(receita),c:'#4ADE80',bg:'rgba(34,197,94,.10)',bd:'rgba(34,197,94,.26)',ico:'↑'},
